...
macro_rules! Scan_the_preamble_and_record_it_in_the_preamble_list {
    ($globals:expr, $save_cs_ptr:expr) => {{
        ...
        loop {
            Append_the_current_tabskip_glue_to_the_preamble_list!($globals);
            ...
            Scan_preamble_text_until_cur_cmd_is_tab_mark_or_car_ret__looking_for_changes_in_the_tabskip_glue__append_an_alignrecord_to_the_preamble_list!($globals);
            // end;
        }
