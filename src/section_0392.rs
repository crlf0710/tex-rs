                ...
                region_forward_label!(
                    |'found|
                    {
                        ...
                        if $globals.cur_tok == $info_r {
                            ...
                            Advance_r__goto_found_if_the_parameter_delimiter_has_been_fully_matched__otherwise_goto_continue!
                        ...
                        if $globals.cur_tok < right_brace_limit {
                            ...
                            if $globals.cur_tok < left_brace_limit {
                                ...
                                Contribute_an_entire_group_to_the_current_parameter!($globals, $p, $q, $unbalance, rbrace_ptr);
                            }
