...
pub(crate) static hyph_word: Box<hyph_pointer_array<str_number>> = Box::new(hyph_pointer_array::default());
// @!hyph_list:array[hyph_pointer] of pointer; {lists of hyphen positions}
/// lists of hyphen positions
#[globals_struct_field(TeXGlobals)]
pub(crate) static hyph_list: Box<hyph_pointer_array<hyph_pointer>> = Box::new(hyph_pointer_array::default());
