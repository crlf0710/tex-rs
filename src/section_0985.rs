...
pub(crate) fn print_totals(globals: &mut TeXGlobals) {
    ...
    // print_plus(2)("");
    print_plus!(globals, 2, strpool_str!(""));
    // print_plus(3)("fil");
    print_plus!(globals, 3, strpool_str!("fil"));
    // print_plus(4)("fill");
    print_plus!(globals, 4, strpool_str!("fill"));
    // print_plus(5)("filll");
    print_plus!(globals, 5, strpool_str!("filll"));
