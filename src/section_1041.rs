...
macro_rules! Append_a_normal_inter_word_space_to_the_current_list__then_goto_big_switch {
    ($globals:expr, $lbl_big_switch:lifetime) => {{
        ...
        if space_skip!($globals) == zero_glue {
            ...
            Find_the_glue_specification_main_p_for_text_spaces_in_the_current_font!
                ($globals);
