...
pub(crate) macro Incorporate_character_dimensions_into_the_dimensions_of_the_hbox_that_will_contain_it__then_move_to_the_next_node($globals:expr, $p:expr, $h:expr, $d:expr, $x:expr) {{
    /// shift amount
    let mut s: scaled;
