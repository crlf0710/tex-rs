...
pub(crate) macro too_small($globals:expr, $prompt:expr, $lbl_bad_fmt:lifetime) {{
    wake_up_terminal($globals);
    // wterm_ln('---! Must increase the ',#);
    wterm_ln(
        make_globals_io_view!($globals),
        format!("{}{}", "---! Must increase the ", $prompt),
    );
    // @.Must increase the x@>
    // goto bad_fmt;
...
pub(crate) macro Undump_the_unicode_support_data($globals:expr, $lbl_bad_fmt:lifetime) {{
...
pub(crate) fn load_fmt_file(globals: &mut TeXGlobals) -> boolean {
    ...
    |'bad_fmt|
    {
        ...
        crate::section_1308::Undump_constants_for_consistency_check!(globals, 'bad_fmt);
        // @<Undump the string pool@>;
        crate::section_1310::Undump_the_string_pool!(globals, 'bad_fmt);
        // @<Undump the dynamic memory@>;
        crate::section_1312::Undump_the_dynamic_memory!(globals, 'bad_fmt);
        // @<Undump the table of equivalents@>;
        crate::section_1314::Undump_the_table_of_equivalents!(globals, 'bad_fmt);
        // @<Undump the font information@>;
        crate::section_1321::Undump_the_font_information!(globals, 'bad_fmt);
        // @<Undump the hyphenation tables@>;
        crate::section_1325::Undump_the_hyphenation_tables!(globals, 'bad_fmt);
        #[cfg(feature = "unicode_support")]
        Undump_the_unicode_support_data!(globals, 'bad_fmt);
        // @<Undump a couple more things and the closing check word@>;
        crate::section_1327::Undump_a_couple_more_things_and_the_closing_check_word!(globals, 'bad_fmt);
