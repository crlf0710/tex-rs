...
pub(crate) macro If_a_line_number_class_has_ended__create_new_active_nodes_for_the_best_feasible_breaks_in_that_class__then_return_if_r_eq_last_active__otherwise_compute_the_new_line_width($globals:expr, $r:expr, $prev_r:expr, $prev_prev_r:expr, $l:expr, $old_l:expr, $line_width:expr, $break_type:expr, $no_break_yet:expr) {{
    crate::trace_span!("If a line number class...");
    ...
    if $l > $old_l {
            ...
            && ($old_l != $globals.easy_line || $r == last_active!())
        {
            ...
            //   just found@>;
            crate::section_0836::Create_new_active_nodes_for_the_best_feasible_breaks_just_found!(
                $globals,
                $r,
                $prev_r,
                $prev_prev_r,
        ...
        crate::section_0850::Compute_the_new_line_width!($globals, $l, $old_l, $line_width);
        // end;
    }
    // end
