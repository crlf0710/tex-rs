...
//!
// @<Assignments@>=
pub(crate) macro Assignments_1224($globals:expr, $cur_cmd:expr, $a:expr) {{
    // shorthand_def: begin n:=cur_chr; get_r_token; p:=cur_cs; define(p,relax,256);
    let processed = if $cur_cmd == shorthand_def {
        ...
        // othercases begin scan_eight_bit_int;
            ...
            if n == count_def_code as chr_code_repr {
                define!(
                    ...
                    p as _,
                    assign_int,
                    (count_base as integer + $globals.cur_val) as _
                );
            }
            //   dimen_def_code: define(p,assign_dimen,scaled_base+cur_val);
                ...
                define!(
                    ...
                    p as _,
                    assign_dimen,
                    (scaled_base as integer + $globals.cur_val) as _
                );
            }
            //   skip_def_code: define(p,assign_glue,skip_base+cur_val);
                ...
                define!(
                    ...
                    p as _,
                    assign_glue,
                    (skip_base as integer + $globals.cur_val) as _
                )
            }
            //   mu_skip_def_code: define(p,assign_mu_glue,mu_skip_base+cur_val);
                ...
                define!(
                    ...
                    p as _,
                    assign_mu_glue,
                    (mu_skip_base as integer + $globals.cur_val) as _
                )
            }
            //   toks_def_code: define(p,assign_toks,toks_base+cur_val);
                ...
                define!(
                    ...
                    p as _,
                    assign_toks,
                    (toks_base as integer + $globals.cur_val) as _
                )
            }
