...
pub(crate) macro adjust_space_factor($globals:expr) {
...
pub(crate) enum main_loop_status_kind {
    main_loop_wrapup,
...
pub(crate) macro Append_character_cur_chr_and_the_following_characters_if_any_to_the_current_hlist_in_the_current_font__goto_reswitch_when_a_non_character_has_been_fetched
    ($globals:expr, $lbl_reswitch:lifetime, $lbl_big_switch:lifetime) {{
        crate::trace_span!("Append character `cur_chr`...");
        // adjust_space_factor;@/
        ...
        if $globals.main_k == non_address {
            ...
            const _ : () = ();
            main_loop_status = main_loop_status_kind::main_loop_move(2);
        }
        else {
            ...
            const _ : () = ();
            main_loop_status = main_loop_status_kind::main_lig_loop(1);
        }
        // @#
        crate::region_multipart! {
            ('main_loop_cycle, main_loop_status) {
                ...
                main_loop_status_kind::main_loop_wrapup => {
                    crate::section_1035::Make_a_ligature_node__if_ligature_present__insert_a_null_discretionary__if_appropriate!($globals);
                    crate::goto_part_label!('main_loop_cycle, main_loop_status, main_loop_status_kind::main_loop_move(0));
                    unreachable!();
                },
                ...
                main_loop_status_kind::main_loop_move(mut part_idx) => {
                    crate::section_1036::If_the_cursor_is_immediately_followed_by_the_right_boundary_goto_reswitch__if_its_followed_by_an_invalid_character__goto_big_switch__otherwise_move_the_cursor_one_step_to_the_right_and_goto_main_lig_loop!
                ...
                main_loop_status_kind::main_loop_lookahead(mut part_idx) => {
                    crate::section_1038::Look_ahead_for_another_character__or_leave_lig_stack_empty_if_there_s_none_there!
                ...
                main_loop_status_kind::main_lig_loop(mut part_idx) => {
                    crate::section_1039::If_there_s_a_ligature_kern_command_relevant_to_cur_l_and_cur_r__adjust_the_text_appropriately__exit_to_main_loop_wrapup!
                        ($globals, part_idx, 'main_loop_cycle, main_loop_status);
                    unreachable!();
                },
                ...
                main_loop_status_kind::main_loop_move_lig => {
                    crate::section_1037::Move_the_cursor_past_a_pseudo_ligature__then_goto_main_loop_lookahead_or_main_lig_loop!
