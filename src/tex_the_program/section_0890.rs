...
pub(crate) macro Append_a_penalty_node__if_a_nonzero_penalty_is_appropriate($globals:expr, $cur_line:expr, $disc_break:expr, $final_widow_penalty:expr) {{
    ...
    use crate::section_0236::broken_penalty;
    use crate::section_0236::club_penalty;
    use crate::section_0236::inter_line_penalty;
}}
