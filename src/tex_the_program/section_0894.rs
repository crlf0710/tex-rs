...
//
// @<Try to hyphenate...@>=
pub(crate) macro Try_to_hyphenate_the_following_word
    ($globals:expr) {{
        ...
        if s != null {
            ...
            //   should be attempted@>;
            crate::section_0896::Skip_to_node_ha__or_goto_done1_if_no_hyphenation_should_be_attempted!($globals, s, prev_s, 'done1);
            ...
            crate::section_0897::Skip_to_node_hb__putting_letters_into_hu_and_hc!($globals, s);
