...
pub(crate) macro Manufacture_a_control_sequence_name($globals:expr) {{
    crate::trace_span!("Manufacture a control...");
    ...
    crate::section_0374::Look_up_the_characters_of_list_r_in_the_hash_table__and_set_cur_cs!(
        $globals, p, r
    );
    // flush_list(r);
