...
macro_rules! Print_a_symbolic_description_of_this_feasible_break {
    ($globals:expr, $r:expr, $d:expr, $b:expr, $pi:expr, $artificial_demerits:expr) => {{
        ...
        if $globals.printed_node != $globals.cur_p {
            ...
            Print_the_list_between_printed_node_and_cur_p__then_set_printed_node_to_cur_p!
                ($globals);
        }
        // print_nl("@@");
        ...
        // else if type(cur_p)<>glue_node then
            ...
            // else if type(cur_p)=disc_node then print_esc("discretionary")
                ...
                print_esc($globals, strpool_str!("discretionary"));
            }
            ...
            // else print_esc("math");
                ...
                print_esc($globals, strpool_str!("math"));
            }
            // end;
        }
        // print(" via @@@@");
        print($globals, strpool_str!(" via @@").get() as _);
        ...
        // print(" b=");
        print($globals, strpool_str!(" b=").get() as _);
        ...
        print($globals, strpool_str!(" p=").get() as _);
        print_int($globals, $pi);
        print($globals, strpool_str!(" d=").get() as _);
