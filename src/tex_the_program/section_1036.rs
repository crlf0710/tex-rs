...
pub(crate) macro If_the_cursor_is_immediately_followed_by_the_right_boundary_goto_reswitch__if_its_followed_by_an_invalid_character__goto_big_switch__otherwise_move_the_cursor_one_step_to_the_right_and_goto_main_lig_loop
    ...
    crate::trace_span!("If the cursor is immediately followed by the right boundary...");
        ...
        ('main_loop_move, $part_idx) {
            ...
            1 => {
                if !is_char_node!($globals, $globals.lig_stack) {
                    crate::goto_part_label!($lbl_main_loop_cycle, $main_loop_status, main_loop_status_kind::main_loop_move_lig);
                }
                $part_idx = 2;
            },
            ...
            2 => {
                ...
                crate::goto_part_label!($lbl_main_loop_cycle, $main_loop_status, main_loop_status_kind::main_loop_lookahead(0));
            },
        }
    }
