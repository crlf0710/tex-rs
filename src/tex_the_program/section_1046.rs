...
pub(crate) macro abs_mode_plus_cur_cmd_matches_non_math_mode($abs_mode_plus_cur_cmd:expr, $cur_cmd:expr) {
...
pub(crate) macro Math_only_cases_in_non_math_modes_or_vice_versa($abs_mode_plus_cur_cmd:expr) {{
    ...
    let processed =
        if abs_mode_plus_cur_cmd_matches_non_math_mode!($abs_mode_plus_cur_cmd, sup_mark as u16)
            ...
            || abs_mode_plus_cur_cmd_matches_non_math_mode!(
                $abs_mode_plus_cur_cmd,
                math_char_num as u16
            )
            || abs_mode_plus_cur_cmd_matches_non_math_mode!(
                $abs_mode_plus_cur_cmd,
                math_given as u16
