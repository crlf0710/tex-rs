...
pub(crate) fn confusion(globals: &mut TeXGlobals, s: str_number) -> TeXResult<()> {
    ...
    if globals.history < history_kind::error_message_issued {
        ...
        print_err!(globals, crate::strpool_str!("This can't happen ("));
        ...
        help1!(
            globals,
            crate::strpool_str!("I'm broken. Please show this to someone who can fix can fix")
        );
        // end
    }
    // else  begin print_err("I can't go on meeting you like this");
        ...
        print_err!(
            globals,
            crate::strpool_str!("I can't go on meeting you like this")
        );
        // @.I can't go on...@>
        ...
        help2!(
            globals,
            crate::strpool_str!("One of your faux pas seems to have wounded me deeply..."),
            crate::strpool_str!("in fact, I'm barely conscious. Please fix it and try again.")
        );
        // end;
    }
    // succumb;
