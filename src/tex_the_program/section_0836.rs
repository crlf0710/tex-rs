...
pub(crate) macro Create_new_active_nodes_for_the_best_feasible_breaks_just_found($globals:expr, $r:expr, $prev_r:expr, $prev_prev_r:expr, $break_type:expr, $no_break_yet:expr) {{
    ...
    crate::section_0843::Insert_a_delta_node_to_prepare_for_breaks_at_cur_p!(
        $globals,
        $r,
        $prev_r,
        $prev_prev_r
    ...
    for fit_class in fit_class_kind::very_loose_fit as u8..=fit_class_kind::tight_fit as u8 {
        ...
        if $globals.minimal_demerits[fit_class] <= $globals.minimum_demerits {
            ...
            crate::section_0845::Insert_a_new_active_node_from_best_place_fit_class_to_cur_p!(
                $globals,
                $r,
                $prev_r,
                $break_type,
    ...
    crate::section_0844::Insert_a_delta_node_to_prepare_for_the_next_active_node!(
        $globals,
        $r,
        $prev_r,
        $prev_prev_r
