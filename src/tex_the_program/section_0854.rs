...
pub(crate) macro Prepare_to_deactivate_node_r__and_goto_deactivate_unless_there_is_a_reason_to_consider_lines_of_text_from_r_to_cur_p($globals:expr, $b:expr, $r:expr, $prev_r:expr, $artificial_demerits:expr, $node_r_stays_active:expr, $lbl_deactivate:lifetime) {{
    ...
    // else if b>threshold then goto deactivate;
        ...
        crate::goto_forward_label!($lbl_deactivate);
    }
