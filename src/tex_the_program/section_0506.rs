...
pub(crate) macro get_x_token_or_active_char($globals:expr) {{
    // begin get_x_token;
    get_x_token($globals)?;
...
pub(crate) macro Test_if_two_characters_match($globals:expr, $this_if:expr, $b:expr) {{
    ...
    use crate::section_0297::chr_code_type;
    use crate::section_0487::if_char_code;
}}
