...
pub(crate) macro Cases_of_print_cmd_chr_for_symbolic_printing_of_primitives_0231($globals:expr, $cmd:expr, $chr_code:expr) {{
    // assign_toks: if chr_code>=toks_base then
    let processed = if $cmd == assign_toks {
