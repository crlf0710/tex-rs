...
macro_rules! adjust {
    ($selector:expr, $f:expr) => {
        $selector[$f] = $selector[$f] - crate::section_0110::min_quarterword as integer
    }
}

// @<Make final adjustments...@>=
macro_rules! Make_final_adjustments_and_goto_done {
    ($globals:expr, $f:expr, $g:expr, $bch_label:expr, $bchar:expr, $lf:expr, $bc:expr, $ec:expr, $nl:expr, $np:expr,
