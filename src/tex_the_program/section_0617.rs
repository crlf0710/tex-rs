...
pub(crate) macro Initialize_variables_as_ship_out_begins($globals:expr) {{
    ...
    if $globals.total_pages == 0 {
        ...
        print($globals, crate::strpool_str!(" TeX output ").get() as _);
    ...
    use crate::section_0532::ensure_dvi_open;
