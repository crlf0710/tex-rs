...
pub(crate) fn ship_out(globals: &mut TeXGlobals, p: pointer) -> TeXResult<()> {
    ...
    if tracing_output!(globals) > 0 {
        ...
        print(globals, strpool_str!("Completed box being shipped out").get() as _);
        // @.Completed box...@>
        // end;
    }
    ...
    Flush_the_box_from_memory__showing_statistics_if_requested!(globals, p);
    // end;
    ok_nojump!()
}
