...
pub(crate) macro Cases_of_main_control_that_build_boxes_and_lists_1090($globals:expr, $abs_mode_plus_cur_cmd:expr) {{
    // vmode+start_par: new_graf(cur_chr>0);
    let processed = if $abs_mode_plus_cur_cmd == vmode as u16 + start_par as u16 {
