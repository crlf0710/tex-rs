...
pub(crate) macro copy_to_cur_active($globals:expr, $idx:expr) {{
...
pub(crate) fn try_break(
    ...
    let _ = (|| {
        ...
        loop {
            ...
            crate::section_0832::If_node_r_is_of_type_delta_node__update_cur_active_width__set_prev_r_and_prev_prev_r__then_goto_continue!
            ...
            crate::section_0835::If_a_line_number_class_has_ended__create_new_active_nodes_for_the_best_feasible_breaks_in_that_class__then_return_if_r_eq_last_active__otherwise_compute_the_new_line_width!
            ...
            crate::section_0851::Consider_the_demerits_for_a_line_from_r_to_cur_p__deactivate_node_r_if_it_should_no_longer_be_active__then_goto_continue_if_a_line_from_r_to_cur_p_is_infeasible__otherwise_record_a_new_feasible_break!
    ...
    crate::region_stat! {
        crate::section_0858::Update_the_value_of_printed_node_for_symbolic_displays!(globals);
    }
    // end;
    crate::ok_nojump!()
}
