...
pub(crate) macro u_part($globals:expr, $val:expr) {
...
pub(crate) macro v_part($globals:expr, $val:expr) {
...
pub(crate) macro extra_info($globals:expr, $val:expr) {
    crate::section_0118::info_inner!(
        $globals,
