...
pub mod TeXGlobals {
    ...
    include!("src/section_0595.rs");
    include!("src/section_0605.rs");
    include!("src/section_0616.rs");
    include!("src/section_0646.rs");
    include!("src/section_0647.rs");
    include!("src/section_0661.rs");
    include!("src/section_0770.rs");
    include!("src/section_0814.rs");
    include!("src/section_0821.rs");
    include!("src/section_0823.rs");
    include!("src/section_0825.rs");
    include!("src/section_0828.rs");
    include!("src/section_0833.rs");
    include!("src/section_0847.rs");
    include!("src/section_0872.rs");
